    ...
    <flux:main class="kirada-shell">
        <div class="kirada-page-header">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <flux:heading size="xl" class="text-slate-950">{{ __('Landlord Dashboard') }}</flux:heading>
                ...
                <a href="{{ route('properties.create') }}" wire:navigate class="inline-flex items-center justify-center rounded-lg bg-sky-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-sky-700">
                    {{ __('Add Property') }}
                </a>
            </div>
        </div>
        ...
        <div class="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="kirada-stat-card">
                ...
                <p class="kirada-stat-value text-emerald-600">{{ $occupied_units }}</p>
            </div>
            <div class="kirada-stat-card">
        ...
        <div class="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="kirada-stat-card">
                ...
                <p class="kirada-stat-value text-emerald-600">{{ number_format($collected_this_month, 0) }} DJF</p>
            </div>
            <div class="kirada-stat-card">
        ...
        <div class="mt-6 kirada-card">
            <h3 class="font-semibold text-slate-950">{{ __('Recent Leases') }}</h3>
        ...
        <div class="mt-4 kirada-card">
            <h3 class="font-semibold text-slate-950">{{ __('Recent Payments') }}</h3>
            <div class="mt-4 divide-y divide-slate-100">
