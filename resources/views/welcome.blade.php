        ...
        <main>
            <section class="relative overflow-hidden border-b border-slate-200 bg-white">
                <div class="mx-auto max-w-7xl px-6 py-16 text-center sm:py-20">
                    ...
                    <h1 class="kirada-reveal kirada-reveal-delay-1 mx-auto mb-5 max-w-4xl text-4xl font-bold tracking-tight text-kirada-navy sm:text-5xl lg:text-6xl">
                        {{ __('Smart Rent Management for Landlords and Tenants') }}
                    </h1>
                    <p class="kirada-reveal kirada-reveal-delay-2 text-lg sm:text-xl text-slate-600 mb-8 max-w-3xl mx-auto">
                        {{ __('Track rent, manage maintenance, communicate with tenants, and store documents — all in one platform.') }}
                    </p>

                    <!-- Hero badges -->
                    <div class="kirada-reveal kirada-reveal-delay-3 mb-10 flex flex-wrap justify-center gap-3">
                    ...
                    <!-- CTAs -->
                    <div class="kirada-reveal kirada-reveal-delay-4 flex flex-col sm:flex-row justify-center gap-4">
                        <a href="{{ route('register') }}" wire:navigate class="kirada-primary-button-lg">
                            {{ __('Get Started') }}
                        </a>
                        <a href="{{ route('login') }}" wire:navigate class="rounded-xl border border-slate-300 bg-white px-8 py-3.5 text-base font-semibold text-slate-700 transition duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-0.5 hover:border-kirada-sky hover:bg-kirada-soft hover:shadow-md active:translate-y-0 active:scale-[0.98]">
                            {{ __('Log in') }}
                        </a>
                    </div>
                    <p class="kirada-reveal kirada-reveal-delay-5 mt-4 text-sm text-slate-400">{{ __('Landlords get a 30-day free trial. No credit card required.') }}</p>

                    <div class="kirada-reveal kirada-reveal-delay-5 mx-auto mt-12 max-w-5xl rounded-xl border border-slate-200 bg-white p-4 text-left shadow-2xl shadow-slate-200/70">
                        <div class="kirada-float grid gap-4 lg:grid-cols-[1.15fr_0.85fr]">
            ...
            <section class="mx-auto max-w-7xl px-6 py-20">
                <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    <!-- Property Management -->
                    <div class="kirada-feature-card kirada-reveal rounded-lg border border-slate-200 bg-white p-6 shadow-sm hover:shadow-lg hover:border-kirada-ocean">
                        <div class="kirada-feature-icon mb-4 flex size-12 items-center justify-center rounded-xl bg-kirada-soft">
                    ...
                    <!-- Rent Tracking -->
                    <div class="kirada-feature-card kirada-reveal kirada-reveal-delay-1 rounded-lg border border-slate-200 bg-white p-6 shadow-sm hover:shadow-lg hover:border-kirada-green">
                        <div class="kirada-feature-icon mb-4 flex size-12 items-center justify-center rounded-xl bg-green-50">
                    ...
                    <!-- Maintenance -->
                    <div class="kirada-feature-card kirada-reveal kirada-reveal-delay-2 rounded-lg border border-slate-200 bg-white p-6 shadow-sm hover:shadow-lg hover:border-kirada-sky">
                        <div class="kirada-feature-icon mb-4 flex size-12 items-center justify-center rounded-xl bg-kirada-sky/15">
                    ...
                    <!-- Multi-country -->
                    <div class="kirada-feature-card kirada-reveal kirada-reveal-delay-2 rounded-lg border border-slate-200 bg-white p-6 shadow-sm hover:shadow-lg hover:border-kirada-ocean">
                        <div class="kirada-feature-icon mb-4 flex size-12 items-center justify-center rounded-xl bg-kirada-soft">
            ...
            <section class="mx-auto max-w-7xl px-6 pb-20">
                <div class="kirada-reveal kirada-gradient-animate rounded-xl bg-gradient-to-r from-kirada-ocean via-kirada-sky to-kirada-green px-8 py-12 text-center shadow-xl shadow-slate-200">
            ...
            <section class="mx-auto max-w-7xl px-6 pb-20 text-center">
                <h2 class="kirada-reveal text-2xl font-bold text-slate-900 mb-4">{{ __('Ready to get started?') }}</h2>
                <div class="kirada-reveal kirada-reveal-delay-1">
                    <a href="{{ route('register') }}" wire:navigate class="group inline-flex items-center gap-2 rounded-xl bg-kirada-ocean px-10 py-4 text-lg font-semibold text-white shadow-lg shadow-kirada-ocean/25 transition duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-0.5 hover:bg-kirada-navy hover:shadow-xl hover:shadow-kirada-ocean/30 active:translate-y-0 active:scale-[0.98]">
                        {{ __('Create Your Free Account') }}
                        <svg class="size-5 transition-transform duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                    </a>
                </div>
