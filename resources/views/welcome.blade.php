        ...
        <header class="sticky top-0 z-40 border-b border-slate-200 bg-white/90 backdrop-blur-md">
            <div class="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-4 sm:px-6">
                <div class="flex min-w-0 items-center">
                    <x-brand-logo class="h-10 w-auto max-w-[160px] sm:h-12 sm:max-w-[190px]" />
                </div>

                <div class="flex shrink-0 items-center gap-2 sm:gap-3">
                    <x-language-switcher />

                    <a href="{{ route('login') }}" wire:navigate class="whitespace-nowrap text-sm font-medium text-slate-600 hover:text-sky-600 transition">
                        {{ __('Log in') }}
                    </a>

                    <a href="{{ route('register') }}" wire:navigate class="whitespace-nowrap rounded-lg bg-sky-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-sky-700 transition">
                        {{ __('Register') }}
                    </a>
                </div>
            </div>
        ...
        <main>
            <section class="relative overflow-hidden border-b border-slate-200 bg-white">
                <div class="mx-auto max-w-7xl px-6 py-16 text-center sm:py-20">
                    ...
                    <h1 class="mx-auto mb-5 max-w-4xl text-4xl font-bold tracking-tight text-slate-950 sm:text-5xl lg:text-6xl">
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-4">
                        <a href="{{ route('register') }}" wire:navigate class="rounded-xl bg-sky-600 px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-sky-500/25 hover:bg-sky-700 transition">
                            {{ __('Get Started') }}
                        </a>
                        ...
                        <div class="grid gap-4 lg:grid-cols-[1.15fr_0.85fr]">
                            <div class="rounded-lg border border-slate-200 bg-slate-50 p-4">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-sm font-semibold text-slate-950">{{ __('Portfolio Health') }}</p>
                                        <p class="text-xs text-slate-500">{{ __('June rent cycle') }}</p>
                                    </div>
                                    <span class="rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700">{{ __('On track') }}</span>
                                </div>
                                <div class="mt-4 grid gap-3 sm:grid-cols-3">
                                    <div class="rounded-lg bg-white p-4 shadow-sm">
                                        <p class="text-xs font-medium text-slate-500">{{ __('Collected') }}</p>
                                        <p class="mt-2 text-2xl font-bold text-emerald-600">840K</p>
                                    </div>
                                    <div class="rounded-lg bg-white p-4 shadow-sm">
                                    ...
                                    <div class="rounded-lg bg-white p-4 shadow-sm">
                                        ...
                                        <p class="mt-2 text-2xl font-bold text-sky-600">5</p>
                                    </div>
                                </div>
                                <div class="mt-4 space-y-2">
                                    ...
                                    <div class="flex items-center justify-between rounded-lg bg-white px-4 py-3 text-sm shadow-sm">
                                        ...
                                        <span class="text-sky-600">{{ __('In progress') }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="rounded-lg border border-slate-200 bg-black p-5 text-white">
            ...
            <section class="mx-auto max-w-7xl px-6 py-20">
                <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    <!-- Property Management -->
                    <div class="rounded-lg border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md hover:border-sky-300 transition">
                    ...
                    <!-- Rent Tracking -->
                    <div class="rounded-lg border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md hover:border-emerald-300 transition">
                    ...
                    <!-- Maintenance -->
                    <div class="rounded-lg border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md hover:border-cyan-300 transition">
            ...
            <section class="mx-auto max-w-7xl px-6 pb-20">
                <div class="rounded-xl bg-gradient-to-r from-sky-600 via-cyan-600 to-emerald-600 px-8 py-12 text-center shadow-xl shadow-slate-200">
            ...
            <section class="mx-auto max-w-7xl px-6 pb-20 text-center">
                ...
                <a href="{{ route('register') }}" wire:navigate class="inline-flex items-center gap-2 rounded-xl bg-sky-600 px-10 py-4 text-lg font-semibold text-white shadow-lg shadow-sky-500/25 hover:bg-sky-700 transition">
            ...
            <div class="mx-auto max-w-7xl px-6 py-8">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div class="flex items-center gap-2">
                        <div class="flex aspect-square size-7 items-center justify-center rounded bg-black">
